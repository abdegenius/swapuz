...
<div class="flex flex-col space-y-4 px-4 sm:px-8 md:px-16 lg:px-24 xl:px-60">
	...
	<div class="flex py-16 flex-col justify-center items-center space-y-12">
		<h1 class="text-4xl xl:text-6xl text-white font-black">Contact Us</h1>
		<div class="max-w-lg w-full mx-8">
			<form class="bg-zinc-800 rounded-xl flex flex-col space-y-2 justify-start py-8 px-12">
				<div
				...
				>
					...
					<select
						class="w-full p-4 bg-transparent border-none shadow-none outline-none select-none appearance-none placeholder:text-zinc-400 text-sm text-zinc-100 font-bold"
					>
				...
				<button
					class="w-full p-5 bg-green-500 text-center text-md font-bold text-zinc-800 rounded-xl"
					>Send</button
				>
			</form>

			<div class="text-center my-8 text-xs font-normal text-zinc-600">
				Or you can contact us via e-mail and telegram
			</div>
